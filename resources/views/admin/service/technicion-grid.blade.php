...
<div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                            <div>
                                <ul class="nav nav-pills">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('admin.service.technicians-list') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="List"><i class="bx bx-list-ul"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link active" href="{{ route('admin.service.technicians-grid') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Grid"><i class="bx bx-grid-alt"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <div class="dropdown text-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            href="javascript:void(0);" onclick="editTechnician({{ $tech->t1_id }})">
                                                Edit
                                            </a>

                                            <a class="dropdown-item"
                                            href="javascript:void(0);" onclick="viewTechnician({{ $tech->t1_id }})">
                                                View
                                            </a>
                                    ...
                                    @if(!empty($tech->photo))
                                        <div class="mx-auto mb-4">
                                            <img src="{{ asset('storage/' . $tech->photo) }}"
                                                alt="{{ $tech->name }}"
                                    ...
                                    <h5 class="font-size-16 mb-1">
                                        <a href="{{ route('admin.service.technicians.show', $tech->t1_id) }}"
                                        class="text-body">
                                            {{ $tech->name ?? '-' }}
                                        </a>
                                    </h5>
                                ...
                                <div class="btn-group" role="group">
                                    <a href="javascript:void(0);" onclick="viewTechnician({{ $tech->t1_id }})"
                ...
                <div class="row g-0 align-items-center mb-4 mt-4">
                    ...
                    <div class="col-sm-6">
                        <p class="mb-sm-0">
                            Showing {{ $technicians->firstItem() ?? 0 }}
                            to {{ $technicians->lastItem() ?? 0 }}
                            of {{ $technicians->total() }} entries
                        </p>
                    </div>
