                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered dt-responsive nowrap w-100" id="admins-datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><input type="checkbox" data-admin-id="{{ $admin->k1_id }}"></td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-muted">{{ optional($admin->sdf_ua)->format('M d, Y') ?? '-' }}</span>
                                        </td>
                                        <td>
                                            <span class="text-muted">{{ optional($admin->wer_ca)->format('M d, Y') ?? '-' }}</span>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                @if(!$admin->verified)
                                                    <button type="button" class="btn btn-success btn-sm verify-admin" 
                                                            data-id="{{ $admin->k1_id }}" title="Verify Admin">
                                                        <i class="bx bx-check"></i>
                                                    </button>
                                                @endif
                                                @if($admin->is_active)
                                                    <button type="button" class="btn btn-warning btn-sm deactivate-admin" 
                                                            data-id="{{ $admin->k1_id }}" title="Deactivate">
                                                        <i class="bx bx-user-x"></i>
                                                    </button>
                                                @else
                                                    <button type="button" class="btn btn-info btn-sm activate-admin" 
                                                            data-id="{{ $admin->k1_id }}" title="Activate">
                                                        <i class="bx bx-user-check"></i>
                                                    </button>
                                                @endif
                                                
                                                <button type="button" class="btn btn-info btn-sm" >
                                                    <a class="dropdown-item" href="#" onclick="editAdmin({{ $admin->k1_id }})"><i class="bx bx-edit me-2"></i>Edit</a>
                                                </button>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li></li>
                                                        <li><a class="dropdown-item" href="#" onclick="sendSecurityCode({{ $admin->k1_id }})"><i class="bx bx-key me-2"></i>Reset Password</a></li>
                                                        <li><a class="dropdown-item" href="#" onclick="sendVerificationEmail({{ $admin->k1_id }})"><i class="bx bx-mail-send me-2"></i>Send Verification</a></li>
                                                        <li><a class="dropdown-item" href="#" onclick="sendReactivationEmail({{ $admin->k1_id }})"><i class="bx bx-refresh me-2"></i>Send Reactivation</a></li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        @if($admin->k1_id !== auth('admin')->id())
                                                            @if($totalAdmins > 1)
                                                                <li><a class="dropdown-item text-danger" href="#" onclick="deleteAdmin({{ $admin->k1_id }})">
