                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                <div class="dropdown text-end">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="#" onclick="viewCustomer({{ $customer->k2_id }})">View Details</a>
                                        <a class="dropdown-item" href="#" onclick="editCustomer({{ $customer->k2_id }})">Edit</a>
                                        <a class="dropdown-item" href="#" onclick="sendEmailToCustomer({{ $customer->k2_id }})">Send Email</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger" href="#" onclick="deleteCustomer({{ $customer->k2_id }})">Remove</a>
                                    </div>
                                </div>
                                ...
                                <h5 class="font-size-16 mb-1">
                                    <a href="#" class="text-body" onclick="viewCustomer({{ $customer->k2_id }})">
                                        @if(strpos($customer->name, '[') === 0)
                                            <span class="badge bg-warning text-dark">Data Locked</span>
                                        @else
                                            {{ $customer->name ?? 'N/A' }}
                                        @endif
                                    </a>
                                ...
                                <p class="text-muted mb-2">
                                    @if(strpos($customer->email, '[') === 0)
                                        <small class="badge bg-warning">Update required</small>
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-outline-light text-truncate" onclick="viewCustomer({{ $customer->k2_id }})">
                                    <i class="uil uil-user me-1"></i> Profile
                                </button>
                                <button type="button" class="btn btn-outline-light text-truncate" onclick="sendEmailToCustomer({{ $customer->k2_id }})">
