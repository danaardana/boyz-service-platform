                ...
                <div class="email-leftbar card">
                    <div class="mail-list mt-4">
                        <a href="{{ route('admin.messages.index', ['filter' => 'inbox']) }}">
                            ...
                            @php
                                $unreadCount = \App\Models\ContactMessage::notDeleted()->unread()->count();
                            @endphp
                            @if($unreadCount > 0)
                    ...
                    <div class="btn-toolbar gap-2 p-3" role="toolbar">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-primary waves-light waves-effect mark-read" 
                                    data-id="{{ $message->k3_id }}" title="Mark as Read">
                                <i class="fa fa-check"></i>
                            </button>
                            @endif
                            @if($message->is_deleted)
                                <button type="button" class="btn btn-success waves-light waves-effect" 
                                        onclick="restoreMessage({{ $message->k3_id }})" title="Move to Inbox">
                                         ...
                                         <div class="modal-dialog modal-dialog-centered" role="document">
                                             <div class="modal-content">
                                                 ...
                                                 <div class="modal-footer">
                                                     ...
                                                     @if($message->is_deleted)
                                                         <button type="button" class="btn btn-danger" onclick="confirmPermanentDelete({{ $message->k3_id }})">
                                                             <i class="fas fa-trash me-1"></i>Permanently Delete
                                                         </button>
                                                     @else
                                                         <button type="button" class="btn btn-warning" onclick="confirmMoveToTrash({{ $message->k3_id }})">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" onclick="assignToMe({{ $message->k3_id }})">Assign to Me</a>
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                @if($message->is_read)
                                <a class="dropdown-item" href="#" onclick="markAsUnread({{ $message->k3_id }})">Mark as Unread</a>
                                @endif
                                <a class="dropdown-item" href="#" onclick="toggleImportant({{ $message->k3_id }})">Toggle Important</a>
                                <a class="dropdown-item" href="#" onclick="exportMessage({{ $message->k3_id }})">Export</a>
