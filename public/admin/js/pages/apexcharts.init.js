...
var options = {
    ...
    series: [{
      name: "Access",
      data: errorTrendChart.access
    },
    {
      name: "Error",
      data: errorTrendChart.error
    }
    ],
    title: {
      text: 'Error count per hour / per day',
      align: 'left',
      style: {
        fontWeight:  '500',
      },
    ...
    xaxis: {
    categories: window.errorTrendChart?.labels || [],
    title: {
        text: 'Period'
    },
    labels: {
...
var options = {
    ...
    series: [
        {
            name: "Login Success",
            data: window.loginChartData.success
        },
        {
            name: "Login Failure",
            data: window.loginChartData.failure
        },
        {
            name: "Total Login",
            data: window.loginChartData.total
        }
    ],
    title: {
    ...
    xaxis: {
        categories: window.loginChartData.labels
    },
    tooltip: {
      y: [{
        title: {
