...
var categoryChart2 = {
    series:  window.systemHealthChartData 
        ? window.systemHealthChartData.series 
        : [0, 0, 0, 0],
    chart: {
        type: 'pie',
        height: 285,
    ...
    colors: ['#2ab57d', '#5156be', '#4ba6ef', '#fd625e'],
    legend: {
        show: false
    },
    dataLabels: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize Category Chart
    if (document.getElementById('category-chart2')) {
        var catChart = new ApexCharts(
            document.querySelector("#category-chart2"), 
            categoryChart2
        );
        catChart.render();
    }
