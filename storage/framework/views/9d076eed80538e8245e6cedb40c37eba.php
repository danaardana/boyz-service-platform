...
<head>    
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo e(asset('landing/images/favicon.ico')); ?>">
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('landing/images/favicon.ico')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('landing/images/logo-white.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('landing/images/logo-white.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('landing/images/logo-white.png')); ?>">
    ...
    <!-- choices css -->
    <link href="<?php echo e(asset('admin/libs/choices.js/public/assets/styles/choices.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<script>
    ...
    const pusherCluster = '<?php echo e(config('broadcasting.connections.pusher.options.cluster')); ?>';
...
$(document).ready(function() {
    ...
    function startSessionMonitoring() {
        ...
        sessionCheckInterval = setInterval(function() {
            $.ajax({
                url: '<?php echo e(route("admin.session.check")); ?>',
                type: 'GET',
                headers: {
                ...
                success: function(response) {
                    if (!response.authenticated) {
                        ...
                        window.location.href = response.redirect || '<?php echo e(route("admin.login")); ?>';
                    }
                },
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        window.location.href = (response && response.redirect) || '<?php echo e(route("admin.login")); ?>';
                    }
    ...
    $(document).ajaxError(function(event, xhr, settings) {
        if (xhr.status === 401) {
            ...
            // Redirect to login
            const response = xhr.responseJSON;
            const redirectUrl = (response && response.redirect) || '<?php echo e(route("admin.login")); ?>';
...
</html><?php /**PATH C:\Users\rioar\Documents\Porotofolio 1 Boyz Projectz\boyzproject-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>