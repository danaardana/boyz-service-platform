...
use App\Session\ObfuscatedDatabaseSessionHandler;
...
{
    /**
     * Create an instance of the database session driver using obfuscated columns.
     */
    protected function createDatabaseDriver()
    {
        $table = $this->config->get('session.table', 'qwe_9k2p');
        $lifetime = $this->config->get('session.lifetime');

        return $this->buildSession(new ObfuscatedDatabaseSessionHandler(
