...
class DocumentationController extends Controller
{
    ...
    private function getAvailableSystems()
    {
        return [
            ...
            'obfuscation-security' => [
                'title' => 'Database Obfuscation & Security',
                'description' => 'Documentation for obfuscated database schema, mapping, and code updates supporting the security feature.',
                'category' => 'Security',
                'version' => '1.0.0',
            ...
            ,
            'obfuscation-mapping' => [
                'title' => 'Obfuscation Mapping',
                'description' => 'Full table and column obfuscation mapping used by the security feature.',
                'category' => 'Security',
                'version' => '1.0.0',
                'lastUpdated' => 'February 2026',
                'icon' => 'bx-tool',
