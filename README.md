...
6. **Compile & Run**
   ...
   ```
7. **Create Admin**
   Go to your link .../admin/register
...
## 🔐 Important: APP_KEY Dependency for Encrypted Data

This application uses Laravel’s built-in encryption (`Crypt`) to secure sensitive data stored in the database (such as customer information and other protected fields).

> ⚠️ **Encrypted data in this project is tied to a specific `APP_KEY`.**

The encrypted data will only decrypt correctly when this exact key is used in your `.env` file:

```env
APP_KEY=base64:6PSZhVw4DdEWriHXW7w31wSFaM2JNzq9DbS+GJC2dYw=
```

### ❗ What happens if you change the APP_KEY?

If you generate a new key using:

```bash
php artisan key:generate
```

then previously encrypted database values will no longer be readable.
...
Encrypted fields (for example customer data) may appear corrupted, empty, or return exceptions during access.

### ✅ When is it safe to change APP_KEY?

You may only change the `APP_KEY` if:

* The database is still empty, **or**
* You are prepared to permanently delete all encrypted data and re-enter it

Otherwise, **do not change the APP_KEY** for this project.

### 🔒 Deployment Recommendation

* Always copy the original `APP_KEY` from the development environment
* Store it securely in your production secrets manager or server environment
* Never expose this key in public repositories, screenshots, or documentation outside secure channels



**Summary:** Changing the `APP_KEY` after data has been encrypted will make that data permanently unreadable.
...
## **📝 Updates History**
<details> 
<summary>Latest Version 2.3.0 (February 2026) - Admin Navigation & Role System Upgrade (Current)</summary>

### **🧭 Dynamic Admin Navigation System**
- ✅ Config-Based Sidebar: Replaced hardcoded Blade sidebar with dynamic menu configuration via config/admin_menu.php
- ✅ Multi-Level Menu Support: Sidebar now supports menu, submenu, and sub-submenu structures
- ✅ Route Parameter Support: Menu system now handles routes requiring parameters (e.g., documentation pages)
- ✅ Automatic Active Highlighting: Sidebar detects current route and expands the correct menu automatically
- ✅ Centralized Navigation Control: All admin navigation managed from a single configuration file

### **👤 Admin Role Management System**
- ✅ New Role Column: Added required role field to the admin table
- ✅ Role Selection UI: Admin create and edit forms now include role selection
- ✅ Role-Based Access Control: Menu visibility and feature access now controlled by admin role
- ✅ Supported Roles:
- Owner – Full system access
- Marketing – Products, landing pages, promotions
- Support – Chat, messages, documentation

### **🔧 System Architecture Improvements**
- ✅ Blade Simplification: Removed large static sidebar blocks from Blade templates
- ✅ Reusable Menu Renderer: Navigation now generated dynamically from config
- ✅ Scalable Structure: Future modules can be added without modifying layout files
- ✅ Cleaner Permission Flow: Role logic centralized instead of scattered in views

</details>

<details> 
<summary>Version 2.1.3 (February 2026) - Security Obfuscation Updates</summary>

### **🔐 Database Obfuscation Layer**
- ✅ Obfuscated Core Tables: Migrated key tables to encrypted/obfuscated schema
- ✅ Model Key Updates: Updated primary keys and relationships to match obfuscated column mapping
- ✅ Encrypted Data Handling: Implemented accessors and mutators for secure encrypted field usage

### **🛠 Runtime Stability Improvements**
- ✅ Null-Safe Timestamp Handling: Prevented crashes from null date fields in models and views
- ✅ Route Safety Fixes: Updated views to safely handle obfuscated identifiers
- ✅ Notification & Session Security: Added encrypted storage for notifications and sessions

### **📦 New Secure Tables Introduced**
- ✅ Obfuscated Notifications table with encrypted fields
- ✅ Obfuscated Sessions table with encrypted payload and metadata
- ✅ Obfuscated Password Reset tokens with custom broker support
- ✅ Obfuscated Product & Options tables with encrypted content

</details>

<details>
<summary>Version 2.1.1 (June 2025) - Professional Email Branding Enhancement Edition</summary>
...
*Version: 2.3 - Admin Navigation & Role System Upgrade*
